...
from agent.chat_stream_response import assemble_chat_stream_response
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call_chat_completions():
        ...
        return assemble_chat_stream_response(
            content_parts, reasoning_parts, tool_calls_acc, finish_reason,
            role, model_name, usage_obj, managed_egress=getattr(agent, "_run_llm_egress", False) is True,
        )
        ...
        try:
            for _stream_attempt in range(_max_stream_retries + 1):
                ...
                try:
                    ...
                    # Never reopen a canceled or managed paid stream.
                    if _request_cancelled["value"]:
                        logger.debug(
                        ...
                        return
                    if getattr(agent, "_run_llm_egress", False) is True:
                        result["error"] = e
                        return
